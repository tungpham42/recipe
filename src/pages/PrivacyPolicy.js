  ...
  vi: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Thông tin Chúng tôi Thu thập</h5>
        ...
        <h5 class="text-primary">Cách Chúng tôi Sử dụng Thông tin của Bạn</h5>
        ...
        <h5 class="text-primary">Chia sẻ Thông tin của Bạn</h5>
        ...
        <h5 class="text-primary">Cookies và Theo dõi</h5>
        ...
        <h5 class="text-primary">Lựa chọn của Bạn</h5>
        <p>Bạn có thể:</p>
        <ul>
        ...
        <h5 class="text-primary">Bảo mật Dữ liệu</h5>
  ...
  fr: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Informations que Nous Collectons</h5>
        ...
        <h5 class="text-primary">Comment Nous Utilisons Vos Informations</h5>
        ...
        <h5 class="text-primary">Partage de Vos Informations</h5>
        ...
        <h5 class="text-primary">Cookies et Suivi</h5>
        ...
        <h5 class="text-primary">Vos Choix</h5>
        <p>Vous pouvez :</p>
        <ul>
        ...
        <h5 class="text-primary">Sécurité des Données</h5>
  ...
  es: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Información que Recopilamos</h5>
        ...
        <h5 class="text-primary">Cómo Usamos Tu Información</h5>
        ...
        <h5 class="text-primary">Compartir Tu Información</h5>
        ...
        <h5 class="text-primary">Cookies y Seguimiento</h5>
        ...
        <h5 class="text-primary">Tus Opciones</h5>
        <p>Puedes:</p>
        <ul>
        ...
        <h5 class="text-primary">Seguridad de Datos</h5>
  ...
  pt: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Informações que Coletamos</h5>
        ...
        <h5 class="text-primary">Como Usamos Suas Informações</h5>
        ...
        <h5 class="text-primary">Compartilhamento de Suas Informações</h5>
        ...
        <h5 class="text-primary">Cookies e Rastreamento</h5>
        ...
        <h5 class="text-primary">Suas Escolhas</h5>
        <p>Você pode:</p>
        <ul>
        ...
        <h5 class="text-primary">Segurança de Dados</h5>
        ...
        <h5 class="text-primary">Contate-Nos</h5>
  ...
  de: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Informationen, die Wir Sammeln</h5>
        ...
        <h5 class="text-primary">Wie Wir Ihre Informationen Verwenden</h5>
        ...
        <h5 class="text-primary">Weitergabe Ihrer Informationen</h5>
        ...
        <h5 class="text-primary">Cookies und Tracking</h5>
        ...
        <h5 class="text-primary">Ihre Wahlmöglichkeiten</h5>
        <p>Sie können:</p>
        <ul>
        ...
        <h5 class="text-primary">Datensicherheit</h5>
  ...
  it: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Informazioni che Raccogliamo</h5>
        ...
        <h5 class="text-primary">Come Utilizziamo le Tue Informazioni</h5>
        ...
        <h5 class="text-primary">Condivisione delle Tue Informazioni</h5>
        ...
        <h5 class="text-primary">Cookie e Tracciamento</h5>
        ...
        <h5 class="text-primary">Le Tue Scelte</h5>
        <p>Puoi:</p>
        <ul>
        ...
        <h5 class="text-primary">Sicurezza dei Dati</h5>
        ...
        <h5 class="text-primary">Contattaci</h5>
  ...
  ru: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">Информация, которую Мы Собираем</h5>
        ...
        <h5 class="text-primary">Как Мы Используем Вашу Информацию</h5>
        ...
        <h5 class="text-primary">Передача Вашей Информации</h5>
        ...
        <h5 class="text-primary">Cookies и Отслеживание</h5>
        ...
        <h5 class="text-primary">Ваши Возможности</h5>
        <p>Вы можете:</p>
        <ul>
        ...
        <h5 class="text-primary">Безопасность Данных</h5>
  ...
  ja: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">収集する情報</h5>
        ...
        <h5 class="text-primary">情報の使用方法</h5>
        ...
        <h5 class="text-primary">情報の共有</h5>
  ...
  ko: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">수집하는 정보</h5>
        ...
        <h5 class="text-primary">정보 사용 방법</h5>
        ...
        <h5 class="text-primary">정보 공유</h5>
  ...
  zh: {
    ...
    html: `
      <div>
        ...
        <h5 class="text-primary">我们收集的信息</h5>
        <p>我们可能会收集以下类型的信息：</p>
        <ul>
        ...
        <h5 class="text-primary">我们如何使用您的信息</h5>
        <p>我们使用您的信息来：</p>
        <ul>
        ...
        <h5 class="text-primary">分享您的信息</h5>
        ...
        <h5 class="text-primary">Cookies和跟踪</h5>
        <p>我们使用cookies来存储您的语言偏好并改善您的体验。您可以在浏览器设置中禁用cookies，但这可能会影响功能。</p>
        <h5 class="text-primary">您的选择</h5>
        <p>您可以：</p>
        <ul>
          <li>更新或删除您的食谱和评论。</li>
          <li>更改语言设置。</li>
...
const PrivacyPolicy = () => {
  const { t } = useLanguage(); // Get current language from context

  // Use the translated HTML string for the current language
  const translation =
    privacyPolicyTranslations[t] || privacyPolicyTranslations["vi"];
